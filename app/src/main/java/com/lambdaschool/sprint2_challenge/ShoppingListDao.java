...
class ShoppingListDao {
    ...
    static ArrayList<ShoppingItem> getAllItems() {
    ...
    static boolean getCheckedStatus(ShoppingItem item) {
        int status = -1;
    ...
    static void setCheckedStatus(ShoppingItem item, boolean checked) {
        if (MainActivity.preferences != null) {
    ...
    static ArrayList<String> getCheckedBookNames() {
